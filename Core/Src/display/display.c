...
static __attribute__((aligned(32))) __attribute__((section(".ext_ram"))) lv_color_t buf_1[MY_DISP_HOR_RES * MY_DISP_VER_RES];
                        ...
                        lv_color_t      *color_p)
{
  ...
  DMA2D->OMAR = hltdc.LayerCfg[0].FBStartAdress+ (3 * (area->y1 * MY_DISP_HOR_RES + area->x1));
